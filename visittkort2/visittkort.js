...
var personListe = document.getElementById('navnVelger');
navnInput = personListe.value


for (i in persons) {
    const navnNode = document.createElement('option');
    navnNode.innerHTML = i;
    navnNode.value = i;
    navnNode.id = i;
    personListe.appendChild(navnNode);
}

function personvelger(navnInput) {
if(persons[navnInput]["navn"] != ""){
    navnH1EL.innerHTML = persons[navnInput]["navn"]
    document.getElementById("navnBryter").checked = false;
}
else {
    toggleElementer('navnBryter', 'navnH1')
    document.getElementById("navnBryter").checked = true;
}
if(persons[navnInput]["stilling"] != ""){
    stillingH2.innerHTML = persons[navnInput]["stilling"]
    document.getElementById("stillingBryter").checked = false;
}
else {
    toggleElementer('stillingBryter', 'stillingH2')
    document.getElementById("stillingBryter").checked = true;
}
if(persons[navnInput]["kjonn"] != ""){
    kjonnH3EL.innerHTML = persons[navnInput]["kjonn"]
    document.getElementById("kjonnBryter").checked = false;
}
else {
    toggleElementer('kjonnBryter', 'kjonnH3')
    document.getElementById("kjonnBryter").checked = true;
}
if(persons[navnInput]["telefonnummer"] != ""){
    telefonnummerH3EL.innerHTML = persons[navnInput]["telefonnummer"]
    document.getElementById("telefonnummerBryter").checked = false;
}
else {
    toggleElementer('telefonnummerBryter', 'telefonnummerH3')
    document.getElementById("telefonnummerBryter").checked = true;
}
if(persons[navnInput]["forerkort"] != "" || persons[navnInput]["forerkort"] == false || persons[navnInput]["forerkort"] == true){
    document.getElementById("forerkortBryter").checked = false;
    if(persons[navnInput]["forerkort"] == false) {
        forerkortH3EL.innerHTML = persons[navnInput]["navn"] + " har førerkort";
    }
    else {
        forerkortH3EL.innerHTML = persons[navnInput]["navn"] + " har ikke førerkort";
    }
}
else {
    toggleElementer('forerkortBryter', 'forerkortH3')
    document.getElementById("forerkortBryter").checked = true;
}
fodselsdatoH3EL.innerHTML = persons[navnInput]["fodselsdato"]
document.getElementById('visittkortet').style.backgroundColor = `${persons[navnInput]["farge"]}`;
document.getElementById('visittkortet').style.border = "5px solid " + String(persons[navnInput]["borderfarge"]);
}
...
function forerkort(value, element) {
    ...
    if(document.getElementById(value).checked == false) {
        document.getElementById(element).innerHTML = document.getElementById('navnH1').innerHTML + " har ikke førerkort";
    }
    else {
        console.log(document.getElementById('navnH1').innerHTML + " har førerkort");
        document.getElementById(element).innerHTML = document.getElementById('navnH1').innerHTML + " har førerkort";
    }
}
